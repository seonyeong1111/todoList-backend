...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity onThrowException(GeneralException generalException, HttpServletRequest request) {
        BaseErrorCode errorReasonHttpStatus = generalException.getCode();
    ...
    private ResponseEntity<Object> handleExceptionInternal(Exception e, BaseErrorCode reason,
        ...
        ApiResponse<Object> body = ApiResponse.onFailure(null,reason);
//        e.printStackTrace();
        ...
        return super.handleExceptionInternal(
                ...
                body,
                headers,
                reason.getReasonHttpStatus().getHttpStatus(),
                webRequest
        );
    }
    ...
    private ResponseEntity<Object> handleExceptionInternalFalse(Exception e, ErrorStatus errorCommonStatus,
        ...
        ApiResponse<Object> body = ApiResponse.onFailure(errorPoint,errorCommonStatus);
        return super.handleExceptionInternal(
                e,
                body,
                headers,
    ...
    private ResponseEntity<Object> handleExceptionInternalArgs(Exception e, HttpHeaders headers, ErrorStatus errorCommonStatus,
        ...
        ApiResponse<Object> body = ApiResponse.onFailure(errorArgs,errorCommonStatus);
        return super.handleExceptionInternal(
                e,
                body,
                headers,
    ...
    private ResponseEntity<Object> handleExceptionInternalConstraint(Exception e, ErrorStatus errorCommonStatus,
        ...
        ApiResponse<Object> body = ApiResponse.onFailure(null,errorCommonStatus);
        return super.handleExceptionInternal(
                e,
                body,
                headers,
